...
IF NOT DEFINED LIBICONV_BUILD call %VCBUILDTOOLS_PATH% %VCBUILDTOOLS%
...
IF NOT DEFINED LIBICONV_BUILD  SET PATH=%PATH%;%PERL_C_BIN_PATH%
IF NOT DEFINED LIBICONV_BUILD  set PATH=%PATH%;%PERL_BIN_PATH%
IF NOT DEFINED LIBICONV_BUILD  set PATH=%PATH%;%PERL_SITE_BIN_PATH%
