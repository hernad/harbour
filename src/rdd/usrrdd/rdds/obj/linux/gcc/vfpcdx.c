...
HB_INIT_SYMBOLS_EX_END( hb_vm_SymbolInit_VFPCDX, "", 0x0, 0x0003 )
...
HB_FUNC_INIT( VFPCDX_INIT )
{
	static const HB_BYTE pcode[] =
	{
		176,3,0,106,7,86,70,80,67,68,88,0,122,20,
		2,176,4,0,92,13,92,2,106,7,86,70,80,67,
		68,88,0,20,3,176,4,0,92,14,92,2,106,7,
		86,70,80,67,68,88,0,20,3,176,4,0,92,33,
		122,106,7,86,70,80,67,68,88,0,20,3,176,4,
		0,92,16,92,3,106,7,86,70,80,67,68,88,0,
		20,3,7
	};
